...
1. Постановка задачи
Программа получает на вход 2 числа X и Y, не пресыщающих по модулю 109. Нужно найти наибольшее из них и вывести его модуль, при этом нельзя использовать класс Math.
